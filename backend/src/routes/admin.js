...
const RESOURCES = {
  ...
  facility_categories: {
    ...
    order: 'position, name',
    columns: ['site_id', 'name', 'icon', 'fac_type', 'position'],
    required: ['name'],
    booleans: [],
    numbers: ['site_id', 'position'],
    timestamps: [],
  },
  facilities: {
    table: 'facilities',
    order: 'name',
    columns: [
      'site_id', 'category_id', 'name', 'description', 'location', 'cover_image',
      'capacity', 'opens_at', 'closes_at', 'slot_minutes', 'price_per_slot',
      'max_per_user', 'active',
    ],
    required: ['name'],
    booleans: ['active'],
    numbers: ['site_id', 'category_id', 'capacity', 'slot_minutes', 'price_per_slot', 'max_per_user'],
    timestamps: [],
  },
  facility_bookings: {
    table: 'facility_bookings',
    order: 'starts_at DESC',
    columns: ['facility_id', 'user_id', 'starts_at', 'ends_at', 'status', 'amount_paid', 'notes'],
    required: ['facility_id', 'user_id', 'starts_at', 'ends_at'],
    booleans: [],
    numbers: ['facility_id', 'user_id', 'amount_paid'],
    timestamps: ['starts_at', 'ends_at'],
  },
  document_folders: {
    table: 'document_folders',
    order: 'position, name',
    columns: ['site_id', 'name', 'description', 'position'],
    required: ['name'],
    booleans: [],
    numbers: ['site_id', 'position'],
    timestamps: [],
  ...
  documents: {
    ...
    columns: ['site_id', 'folder_id', 'title', 'description', 'file_url', 'file_type', 'size_kb'],
    required: ['title', 'file_url'],
    booleans: [],
    numbers: ['site_id', 'folder_id', 'size_kb'],
    timestamps: [],
  },
  sos_contacts: {
    table: 'sos_contacts',
    order: 'is_urgent DESC, position, name',
    columns: ['site_id', 'name', 'role', 'phone', 'category', 'is_urgent', 'position'],
    required: ['name', 'phone'],
    booleans: ['is_urgent'],
    numbers: ['site_id', 'position'],
    timestamps: [],
